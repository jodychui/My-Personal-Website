  ...
  return (
    <div id='AboutMe' className='w-full h-screen bg-[#D1CAC1] text-indigo-900'>
        <div className='mx-auto flex-col text-center pt-20'>
            <h1 className='text-5xl text-center lg:text-5xl 2xl:text-7xl font-bold inline border-b-4 border-pink-600'>About Me</h1>
        </div>
        {/* both sections */}
        <div className='text-center'>
            ...
            <div className='flex flex-col justify-center items-center'>
                ...
                <p className='justify-center items-center mx-6 text-lg max-w-[1350px] md:text-xl lg:text-2xl text-indigo-900 '>
                    Hi, I’m Jodi. I am currently pursuing a B.S. in Computer Science and minoring in Entrepreneurship and 
